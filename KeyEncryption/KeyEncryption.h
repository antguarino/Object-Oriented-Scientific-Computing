...
/** Finds the key provided an encrypted and decrypted string
 *
 *  \param[in]   str             unencrypted string
 *  \param[in]   encrypted_str   encrypted string
 *
 *  \return   the encryption key
 */
std::string KeyFinder(const std::string& encrypted_str, const std::string& str);
}

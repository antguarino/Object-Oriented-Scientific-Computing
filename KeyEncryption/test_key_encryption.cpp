...
int main() {
  ...
  auto decrypted_key = ipcv::KeyFinder(encrypted_str, str);
  ...
  cout << "Decrypted Key: " << endl << decrypted_key << endl;
  cout << endl;
  cout << "Decrypted String (Decrypted Key): " << endl << ipcv::KeyDecrypt(decrypted_key, encrypted_str) << endl;
  cout << endl;
}
